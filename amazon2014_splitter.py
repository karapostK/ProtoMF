...
parser.add_argument('--listening_history_path', '-lh', type=str,
                    help="Path to 'ratings_Video_Games.csv' of the Amazon2014 dataset.")
...
ratings_path = os.path.join(listening_history_path, 'ratings_Video_Games.csv')
...
print(INF_STR.format(len(lhs), lhs.user.nunique(), lhs.item.nunique(), 'Keeping only the first interaction'))
